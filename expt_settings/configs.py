...
class ExperimentConfig(object):
  ...
  default_experiments = ['volatility', 'electricity', 'traffic', 'favorita', 'target_usi']
  ...
  def __init__(self, experiment='volatility', root_folder=None):
    ...
    self.data_folder = os.path.join('/home/featurize', 'data', experiment)
  ...
  def make_data_formatter(self):
    ...
    data_formatter_class = {
        ...
        'target_usi': data_formatters.target_usi.TargetUsiFormatter
    }
